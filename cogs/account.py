...
class account(cogcore):
    ...
    async def account_info(self, ctx, eth_address: str):
        ...
        if (eth_bal != 0):
            ...
            embed.set_thumbnail(
                url="https://cdn.jsdelivr.net/gh/Xeift/image-hosting@main//a8eb74eaa4d1148c2b33db119edb9515.gif")
            embed.add_field(name="ETH balance", value=str(eth_bal)[0:7] + "||" + str(eth_bal)[7:20] + "||" + " ETH",
                            inline=False)
